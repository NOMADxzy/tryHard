...
| [1578. 使绳子变成彩色的最短时间](https://leetcode.cn/problems/number-of-sets-of-k-non-overlapping-line-segments/description/) | dp(i)(k) 表示i点前 分配 k段绳子的方法数                | [我的提交](https://leetcode.cn/problems/number-of-sets-of-k-non-overlapping-line-segments/submissions/477865061/) |
